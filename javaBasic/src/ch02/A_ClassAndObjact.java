...
class ExampleClass1 {
	...
	int method1 (int arg1, int arg2) {
		// 기능구현
		// 반환타입이 void가 아니면 반드시 return으로 결과를 변환해야 함
		return 0;
	}
	// 매개변수 : X, 반환값 : O
	int method2 () {
...
//	void overloadMethod(double double1, int int2) {
//		// 매개변수 이름을 바꿔도 오류뜸
//	} 
...
public class A_ClassAndObjact {
	...
	// 지역변수
    // String team; //메서드 => 지역변수
		
		// 인스턴스: 특정 클래스로 정의된 것을 실체화 한 것 (객체)
		// 클래스명 참조변수명 = new 클래스명(); <= 생성방법
		...
		// instance 변수와 매서드는 '반드시' 인스턴스를 생성하여 인스턴스로 접근 및 호출
