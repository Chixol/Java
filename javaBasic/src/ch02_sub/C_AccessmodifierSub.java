package ch02_sub; //ch02 package C_AccessModifier 파일과 같이 볼 것

// ch02에 선언된 AccessModifier 클래스는
// 접근 제어자가 default 이기 때문에 외부 패키지에서 import가 불가능
...
public class C_AccessmodifierSub {
	...
	public static void main(String[] args) {
		...
		// C_AccessModifier 클래스의 defaulVariavle 필드는
		// 접근 제어자가 default 이기 때문에 외부 패키지에서는 접근이 불가능
		// instance.defaultVariavle = 0;
		
		// C_AccessModifier 클래스의 protectedVariavle 필드는
