...
public class C_Operator {
	...
	public static void main(String[] args) {
		...
		// 비교 연산: 좌항과 우항을 비교하여 그 결과를 논리값으로 변환
		boolean booleanResult;
		
		// 같다, 다르다 연산
		// == : 좌항과 우항이 같으면 true, 다르면 fasle
		// != : 좌항과 우항이 다르면 true, 같으면 fasle
		booleanResult = a == b;
		...
		// && : AND 연산 - 좌항과 우항이 모두 true이면 true, 하나라도 false 이면 false
		booleanResult = false && false;
		System.out.println(booleanResult);
		booleanResult = a < b && c > d;
		System.out.println(booleanResult);
		// || : OR 연산 - 좌항과 우항이 하나라도 true이면 true, 모두 false 이면 false
		...
		// 삼항 연산자: 간당한 조건에 따라 결과를 반환하는 연산자
