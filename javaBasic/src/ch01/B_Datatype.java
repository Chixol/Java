...
public class B_Datatype {
	...
	public static void main(String[] args) {
		...
		// -128 ~ 127
		byte byte1 = 127;
		// byte byte2 = 128; //128에 빨간 밑줄 뜸

		// short: 2byte(16bit)의 크기를 가지는 정수형 데이터 타입
		// -32768 ~ 32767
		short short1 = 32767;
		// short short2 = 32768; //32768에 빨간 밑줄 뜸
		
		// int: 4byte(32bit)의 크기를 가지는 정수형 데이터 타입
		// -2147483648 ~ 2147483647
		int int1 = 2_147_483_647;
		// int int2 = 2_147_483_648; //2147483648에 빨간 밑줄 뜸
		
		// long: 8byte(64bot)의 크기를 가지는 정수형 데이터 타입
		long long1 = 2_147_483_648L; //<= 숫자 뒤에 L(소문자 상관 없음)을 넣는다
		
		// 0119
		// 실수형 데이터 타입: 실수부를 가지는 데이터 타입
		// float: 4byte(32bit)의 크기를 가지는 실수형 데이터 타입 (맨 뒷자리 (f)입력 대소문자 상관x)
		// 소수점 6-7 자리에서 오차가 발생
		...
		// 문자형 데이터 타입: 문자 하나를 저장할 수 있는 데이터 타입 (문자 2개 입력시 오류)
		...
		number = (int) longNumber; // ()띄어쓰기 안해도 됨
		
		number = 256;
		byte byteNumber = (byte)number;
		System.out.println(byteNumber);  //결과값이 0 나옴(데이터 손실 발생)
		...
		// numbers : {99, 0, 0, 0, 0} X, [I@77f99a05
		System.out.println(numbers);
		
		numbers2 = numbers;
		// numbers2 : {99, 0, 0, 0, 0} X, [I@77f99a05
		System.out.println(numbers2);
		...
		// 5. 문자열 찾기
		// indexOf(문자열): 찾고자하는 문자열의 처음 찾은 위치의 인덱스 번호를 반환 (없는 문자는 -1로 표기)
		...
		String string2 = null;
		// System.out.println(string2.substring(48)); (NullPointerException 발생)
