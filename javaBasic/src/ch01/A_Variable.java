...
public class A_Variable {
	...
	public static void main(String[] args) {
		...
		// 변수를 선언한 후 반드시 초기화 이후에 사용할 수 있습니다.
		// int age;
		...
		final double IPHONE_15_PRO_HIGHT = 146.6;
		final double IPHONE_15_PRO_WIDTH = 70.6;
		
		double size2 = IPHONE_15_PRO_HIGHT * IPHONE_15_PRO_WIDTH;
		
		// 리터럴: 값 그 자체 (리터럴 = 리터럴 상수 = 실제 값)
